        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="animate-fade-up">
            <div className="relative w-64 h-64 mx-auto">
              ...
              <div className="relative w-full h-full bg-gradient-to-br from-primary/20 to-chart-2/20 rounded-full border-2 border-primary/30 flex items-center justify-center">
                <img className="text-8xl font-display font-bold rounded-full bg-gradient-to-r from-primary to-chart-2 bg-clip-text text-transparent" src="./avatar_1.png">
                </img>
              </div>
            </div>
          </div>
          ...
          >
            <p className="text-lg leading-relaxed">
              I'm a passionate Senior Full-Stack Engineer specializing in
              building scalable, high-performance web applications. With over 7
              years of experience, I've mastered both backend and frontend
              technologies.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              My expertise spans across Node.js and Python ecosystems, creating
              robust backend systems with Nest.js, Express.js, Django, and
              FastAPI. On the frontend, I craft seamless user experiences with
              React and Next.js.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              I'm proficient in cloud technologies, particularly AWS, where I
              deploy and manage applications using Docker and Kubernetes. My
              approach combines modern architecture patterns with best practices
              to deliver solutions that scale.
            </p>
